...
class FutureYoga_Member extends Widget_Base {
	...
	public function get_title() {
		return __( 'Future Yoga Member', 'fy-elementor-widgets' );
	}

	public function get_icon() {
		return 'fy-icon eicon-person';
	}
	...
	protected function register_controls() {
        ...
        $this->add_control(
			'member_page_link',
			array(
				'label'     => __( 'Member Page Link', 'fy-elementor-widgets' ),
        ...
        $this->add_responsive_control(
			'member_icons_display',
			array(
				'label'     => __( 'Mostra icone social', 'fy-elementor-widgets' ),
	...
	protected function render() {
        ...
        <?php if ( ! empty( $settings['member_page_link']['url'] ) ) : ?>
            <div class="fy-member-link">
            <a href="<?php echo $settings['member_page_link']['url']; ?>" <?php echo $settings['member_page_link']['is_external'] ? 'target="_blank"' : ''; ?> <?php echo $settings['member_page_link']['nofollow'] ? 'rel="nofollow"' : ''; ?> <?php echo $settings['member_page_link']['custom_attributes']; ?>>
        <?php endif; ?>
		...
		<div <?php echo $this->get_render_attribute_string( 'wrap' ); ?>>
            ...
            <?php if ( $settings['member_icons_display'] === 'yes' ) : ?>
